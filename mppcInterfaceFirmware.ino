...
static float calibrationFactor[] = {0.991649187, 0.996861885, 0.987998107, 0.986184943};
//Board 1: calibrationFactor[] = {0.991377493, 0.990100487, 0.98945322, 0.997021941};
//Board 2: calibrationFactor[] = {0.991649187, 0.996861885, 0.987998107, 0.986184943};
//Board 3: calibrationFactor[] = {0.989140057, 0.990593123, 0.98647028, 0.991567505};

// Voltage range , {{min0,max0},{min1,max1}...}
static float voltageRange[][2] = {{53.982, 58.96},
                                  {53.913, 58.889},
                                  {53.993, 58.975},
                                  {53.883, 58.855}};

/*Board 1:                                   
static float voltageRange[][2] = {{53.941, 58.919},
                                  {53.928, 58.899},
                                  {53.858, 58.824},
                                  {53.891, 58.866}};
...
static float voltageRange[][2] = {{53.982, 58.96},
                                 ...
                                 Board 3:                                   
static float voltageRange[][2] = {{53.938, 58.912},
                                  {53.924, 58.9},
                                  {53.898, 58.874},
                                  {53.914, 58.889}};
